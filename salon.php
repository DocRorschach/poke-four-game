...
<html>
    ...
    <body>
        ...
        <div style="background-color: greenyellow;"><!--switchgame -->
            ...
            <div></div><!--Endroi ou métres l'ajax pour les parties ouvertes-->
        </div>
                ...
                <div class="modal-content">
                    <form method="post" action="" name="formconfig">
                        <div class="modal-header">
                            <input type="text">name of your party</input>
                        ...
                        <div class="modal-footer">
                            ...
                            <input class="btn btn-primary" data-dismiss="modal" value="Go" name="formconfig" value="ok" />
                        </div>
                    </form>
                </div>
            </div>
